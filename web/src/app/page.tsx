        ...
        <main className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-4 sm:p-8 mb-4 flex flex-col items-center">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 text-center">Download YouTube Video</h3>
                <p className="text-gray-600 mb-4 text-center text-xs sm:text-sm">
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 sm:gap-3 rounded-xl bg-gradient-to-r from-red-500 to-red-700 shadow-lg px-4 sm:px-6 py-3 sm:py-4 text-white font-bold text-base sm:text-lg hover:from-red-600 hover:to-red-800 transition-all duration-200 mb-2"
                >
              ...
              {/* Video Selector */}
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-4 sm:p-8 hover:shadow-2xl transition-all duration-300">
                <VideoSelector 
                ...
                <>
                  ...
                  <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-4 sm:p-8 hover:shadow-2xl transition-all duration-300">
                    <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
                      ...
                      <h3 className="text-base sm:text-lg font-semibold text-gray-900">Video Preview</h3>
                    </div>
                  ...
                  {selectedVideo.transcript ? (
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-4 sm:p-6">
                      <div className="flex items-center space-x-2 sm:space-x-3">
                        ...
                        <div>
                          <h3 className="text-base sm:text-lg font-semibold text-yellow-900">Transcript Not Available</h3>
                          <p className="text-xs sm:text-sm text-yellow-700">Transcript generation failed or is not available for this video.</p>
                        </div>
                      </div>
                    </div>
                  )}
              ...
              {selectedVideo && (
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-4 sm:p-8 hover:shadow-2xl transition-all duration-300">
                  <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900">AI-Powered GIF Generator</h3>
                  </div>
                  <AiGifGenerator 
